...
if __name__ == "__main__":
    ...
    # data paths
    parser.add_argument('--data_root', type=str, required=True, help='HOI4D_release root')
    parser.add_argument('--anno_root', type=str, required=True, help='HOI4D_annotations root')
    parser.add_argument('--idx_file', type=str, required=True, help='release.txt index file')
